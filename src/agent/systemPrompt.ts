...
- The plan “1x Reformer 1x Mat 1x Step” (100 000 F) is a bespoke plan made for one specific client. NEVER propose, pitch or surface it spontaneously — not in the qualification funnel, not in a list of options; present or sell it ONLY if a client explicitly asks for it by name. It follows the Clé invitation rules above and grants no “cours en plus”.
